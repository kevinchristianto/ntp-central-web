...
@section('title', 'Miscellaneous Logs')
...
<div class="breadcrumb mb-24">
    <ul class="flex-align gap-4">
        ...
        <li><span class="text-gray-500 fw-normal d-flex"><i class="ph ph-caret-right"></i></span> </li>
        <li><span class="text-main-600 fw-normal text-15">Miscellaneous Logs</span></li>
    </ul>
</div>
@endsection
            ...
            <form class="p-0 row" style="row-gap: .5rem" method="GET" action="">
                <div class="col">
                    <select class="form-control form-select h6 rounded-4 m-0 py-6 px-8" name="type">
                        ...
                        <option {{ Request::get('type') == 'misc' ? 'selected' : null }} value="misc">Miscellaneous</option>
                    </select>
                </div>
                <div class="col">
